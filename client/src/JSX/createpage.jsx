...
function Createpage(props) {
    ...
    const addheader = (event) => {
        ...
        if (headerText === '') {
            setMessage("Please enter text for header");
            return;
        }
    ...
    const addparagraph = (event) => {
        event.preventDefault();
        if (paragraphText === '') {
            setMessage("Please enter text for paragraph");
            return;
        }
    ...
    const addimage = (event) => {
        event.preventDefault();
        if (imagename === '') {
            setMessage("Please enter name for image");
            return;
        }
    ...
    const handlesubmit = (event) => {
        ...
        const page = { title, username, creationdate, publicationdate, status, contents };
        props.newpage(page);
        props.setChangemypage(!props.changemypage);
        setNav(true);
    };
                ...
                <Form.Group controlId="formBasicEmail" id="mainform">
                    <Row className="info">
                        ...
                        <Col md={6}>
                            ...
                            <Form.Control type="text" placeholder={props.userinfo.username} disabled={true} />
                        </Col>
                        <Col md={6}>
